...
export class ReportsComponent {
  ...
  emailYear = new Date().getFullYear();
  emailMonth = new Date().getMonth(); // previous month
  sendingEmail = false;
  emailSent = false;
  emailError = '';
  ...
  sendSummaryEmail(): void {
    ...
    this.analyticsApi.sendSummaryEmail(userId, this.emailYear, this.emailMonth).subscribe({
      next: () => {
        this.emailSent = true;
        this.sendingEmail = false;
      },
      error: () => {
        this.emailError = 'Failed to send email. Please check your Gmail configuration.';
        this.sendingEmail = false;
      }
    });
  }
